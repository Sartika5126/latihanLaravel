    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow mt-8">
        ...
        <form action="{{ route('ekyc.step2.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="file" name="file_ktp" accept="image/*" 
            ...
            <div>
                ...
                <input type="file" name="file_selfie" accept="image/*" 
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                @if (!empty($data->file_selfie))
             ...
             <div class="flex justify-between items-center mt-6"> 
                ...
                <a href="{{ route('ekyc.step1') }}" class="text-sm text-gray-500 hover:text-gray-700">
                    ← Kembali ke Step 1
                </a>        <div class="flex justify-end">
                        @if ($data && $data->status === 'submitted')
                            <a href="{{ route('ekyc.step3') }}" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
                                Lanjut ke Step 3
                            </a>
                        @else
