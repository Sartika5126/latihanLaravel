...
<body class="bg-white text-gray-800">
                ...
                @if (Route::has('login'))
                    <nav class="flex items-center justify-end gap-4">
                        @auth 
                            <a 
                                href="{{ url('/dashboard') }}"
                                class="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-lue-700"
                            >
                                Dashboard
                            </a>
                        @else
        ...
        <div>
                ...
                <div class="flex gap-4">
                    @if (Route::has('register'))
                        <a 
                            href="{{ route('register') }}"
                            class="px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-lue-700">
                            Daftar Sekarang
                        </a>
                    @endif
            ...
            <div class="flex justify-center">
                <!-- konten : banner image -->
                <img src="{{ asset('storage/image/landing/mahasiswa-lp3i.jpeg') }}" alt="Mahasiswa LP3I" class="w-full max-w-md object-cover drop-shadow-xl">
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-lg transition">
                    <img src="{{ asset('storage/image/landing/administrasi.png') }}" class="w-full rounded-lg" alt="">
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-lg transition">
                    <img src="{{ asset('storage/image/landing/informatika.jpeg') }}" class="w-full rounded-lg" alt="">
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-lg transition">
                    <img src="{{ asset('storage/image/landing/marketing.jpeg') }}" class="w-full rounded-lg" alt="">
    ...
    <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        ...
        <img src="{{ asset('storage/image/landing/hero-lp3i.png') }}" class="rounded-xl shadow-lg" alt="Kampus LP3I">
    </div>
</section>
...
<footer id="kontak" class="bg-blue-600 text-white py-10">
    ...
    <div class="text-center text-gray-200 mt-10 text-sm">
        &copy; 2025 LP3I. Semua Hak Dilindungi.
    </div>
</footer>
